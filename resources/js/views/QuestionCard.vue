    ...
    <div class="pt-24 flex flex-wrap justify-center bg-quizzlab-primary">
        ...
        <div class="w-5/6 lg:w-4/5 mb-5">
            <div
                ...
                "
                class="text-center text-4xl text-white font-semibold mb-2"
            >
                COMMENTAIRES
            </div>
            <QuestionComment
        ...
        <div v-if="userStore.isConnected == true" class="h-40 w-5/6 lg:w-4/5 mb-40" :class="commentStore.responseMod == true ? 'mb-80' : 'mb-40'">
            <div class="text-center text-4xl text-white font-semibold mb-2">
                {{
                    commentStore.responseMod == true
            ...
            />
            <QuestionCommentEditor class="bg-quizzlab-quinary" />
        </div>
    </div>
</template>
<script setup>
